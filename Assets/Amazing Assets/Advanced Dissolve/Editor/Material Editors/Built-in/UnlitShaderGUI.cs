...
namespace AmazingAssets.AdvancedDissolveEditor
{
    internal class UnlitShaderGUI : ShaderGUI
    {
        ...
        void FindProperties(MaterialProperty[] properties)
        {
            ...
            _MatcapMap = AdvancedDissolveEditor.AdvancedDissolveMaterialProperties.FindProperty("_MatcapMap", properties, true);
            _MatcapIntensity = AdvancedDissolveEditor.AdvancedDissolveMaterialProperties.FindProperty("_MatcapIntensity", properties, true);
            _MatcapBlendMode = AdvancedDissolveEditor.AdvancedDissolveMaterialProperties.FindProperty("_MatcapBlendMode", properties, true);
